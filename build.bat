C:/VulkanSDK/1.2.182.0/Bin/glslc.exe src/level.vert -o data/shaders/level.vert.spv
C:/VulkanSDK/1.2.182.0/Bin/glslc.exe src/level.frag -o data/shaders/level.frag.spv

C:/VulkanSDK/1.2.182.0/Bin/glslc.exe src/entity.vert -o data/shaders/entity.vert.spv
C:/VulkanSDK/1.2.182.0/Bin/glslc.exe src/entity.frag -o data/shaders/entity.frag.spv
